...
public class WavFile
{
	...
	private static long num_chunks_ori;
	...
	public static WavFile openWavFile(File file) throws IOException, WavFileException
	{
		...
		//num_chunks_ori =  (chunkSize%2 == 1) ? chunkSize+1 : chunkSize;
	...
	public  void moveToWaveFile ( long sound_frame_ind){
		
		FileChannel fc = iStream.getChannel();
		try {
			long u=((long)(sound_frame_ind)*bytesPerSample*numChannels) + 32;
			System.out.println("which sound sample wav pointing:"+u);
			fc.position(u);
		} catch (IOException e) {
